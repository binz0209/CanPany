// CanPany.Infrastructure/Persistence/MongoDb/Options/MongoOptions.cs
namespace CanPany.Infrastructure.Persistence.MongoDb.Options;

public class MongoOptions
{
    public string ConnectionString { get; set; } = "mongodb://localhost:27017";
    public string DbName { get; set; } = "CanPanyDev";
    ...
    public class CollectionsSection
    {
        ...
        public string CVs { get; set; } = "cvs";
        public string CVAnalyses { get; set; } = "cv_analyses";
        public string Applications { get; set; } = "applications";
        public string PremiumPackages { get; set; } = "premium_packages";
        public string Reports { get; set; } = "reports";
        public string ExternalSyncs { get; set; } = "external_syncs";
