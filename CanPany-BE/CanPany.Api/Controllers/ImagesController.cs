...
public class ImagesController : ControllerBase
{
    ...
    [Authorize]
    [HttpPost("upload")]
    public async Task<IActionResult> UploadImage(IFormFile file, [FromQuery] string folder = "CanPany")
    {
    ...
    public async Task<IActionResult> UploadMultipleImages(IFormFileCollection files, [FromQuery] string folder = "CanPany")
    {
